			...
			<div class="panel-body">
				<form name="loginForm"
					...
					<div>
						...
						<label>email : &nbsp</label><input type="text"
							name="email" id="login-email" placeholder="email"><br />
						<label>Password : &nbsp</label><input type="password"
							name="passwd" id="login-password" placeholder="password"><br />
	...
	<div class="modal fade" id="signup">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form name="signupForm" action="<c:url value="/user/insertUser"/>" method="POST">
					<!-- ==============signup.php ========================== -->
					<div class="modal-header">Sign Up</div>
					<div class="modal-body">
						<label>email : &nbsp</label><input type="text" name="email"
							id="email" placeholder="email"><br /> <label>Password
							: &nbsp</label><input type="password" name="passwd"
							id="passwd" placeholder="password"><br /> 
						<div class="signup-status"></div>
					</div>
					<div class="modal-footer">
						<input type="submit" value="sign up" class="btn btn-default"></button>
